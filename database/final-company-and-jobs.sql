-- =============================================
-- Create Company and Job Postings (Correct Schema)
-- =============================================
...
VALUES 
    ('comp-001', 'Tech Solutions Inc', 'Tech Solutions Inc', '0123456789', 'Technology', 'https://techsolutions.com', '123 Nguyen Hue Street', 'Ho Chi Minh City', 'Ho Chi Minh', 'Vietnam', '700000', '+84-28-1234-5678', 'info@techsolutions.com', 1, GETDATE(), GETDATE(), 'user-001');
