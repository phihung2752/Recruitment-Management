-- =============================================
-- Add Sample Candidates Data Only
-- =============================================

USE hr_management_system;

-- Insert sample job postings (if not exist)
IF NOT EXISTS (SELECT 1 FROM JobPostings WHERE Id = 'job-001')
INSERT INTO JobPostings (Id, CompanyId, Title, Description, Requirements, Location, WorkType, EmploymentType, ExperienceLevel, Status, PublishedAt, ApplicationDeadline, NumberOfPositions, CreatedAt, UpdatedAt, CreatedById)
VALUES 
    ('job-001', 'comp-001', 'Senior Software Engineer', 'We are looking for an experienced software engineer to join our development team.', 
    ...
    ('job-002', 'comp-001', 'Frontend Developer', 'Join our frontend team to build amazing user experiences.', 
    ...
    ('job-003', 'comp-001', 'Marketing Manager', 'Lead our marketing initiatives and drive growth.', 
     '5+ years marketing experience, Digital marketing, Analytics', 'Da Nang', 'Full-time', 'Permanent', 'Senior', 'Active', GETDATE(), DATEADD(day, 20, GETDATE()), 1, GETDATE(), GETDATE(), 'user-001'),
    
    ('job-004', 'comp-001', 'Data Analyst', 'Analyze data to provide business insights and recommendations.', 
    ...
    ('job-005', 'comp-001', 'UX Designer', 'Design intuitive and beautiful user interfaces.', 
...
VALUES 
    ('int-001', 'Technical Interview - Senior Software Engineer', 'Technical', 
     ...
     'Excellent technical skills, good problem-solving approach. Strong in C# and .NET. Recommended for next round.', GETDATE(), GETDATE(), 'user-001'),
    ...
    ('int-002', 'Technical Interview - Frontend Developer', 'Technical', 
     ...
     'Good understanding of React and modern frontend development. Needs improvement in TypeScript.', GETDATE(), GETDATE(), 'user-001'),
    ...
    ('int-003', 'Behavioral Interview - Marketing Manager', 'Behavioral', 
     ...
     'Strong leadership skills, good strategic thinking. Excellent communication and presentation skills.', GETDATE(), GETDATE(), 'user-001'),
    ...
    ('int-004', 'Technical Interview - Data Analyst', 'Technical', 
     ...
     'Good analytical skills, strong in SQL and Python. Good understanding of data visualization.', GETDATE(), GETDATE(), 'user-001'),
    ...
    ('int-005', 'Portfolio Review - UX Designer', 'Portfolio Review', 
     ...
     'Excellent design portfolio, strong user research skills. Good understanding of design principles.', GETDATE(), GETDATE(), 'user-001'),
    ...
    ('int-006', 'Technical Interview - Senior Software Engineer', 'Technical', 
     ...
     'Upcoming technical interview for senior software engineer position.', GETDATE(), GETDATE(), 'user-001'),
    ...
    ('int-007', 'Technical Interview - Frontend Developer', 'Technical', 
     ...
     'Upcoming technical interview for frontend developer position.', GETDATE(), GETDATE(), 'user-001');

-- Display summary
SELECT 'Sample candidates data added successfully!' AS Message;
