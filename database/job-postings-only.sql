-- =============================================
-- Add Job Postings Only (Company already exists)
-- =============================================
...
IF NOT EXISTS (SELECT 1 FROM Companies WHERE Id = 'comp-001')
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM Departments WHERE Id = 'dept-001')
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM Positions WHERE Id = 'pos-001')
BEGIN
...
-- Insert job postings (only if they don't exist)
