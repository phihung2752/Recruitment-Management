...
export default function CandidateManagement() {
  ...
  const handleStageChange = (candidateId: number, newStage: Candidate['stage']) => {
                    ...
                    <TableRow key={candidate.id}>
                      ...
                      <TableCell>
                        <Select
                          ...
                          onValueChange={(value: Candidate['stage']) => handleStageChange(candidate.id, value)}
                        >
                          <SelectTrigger className="w-[180px]">
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={(value: Candidate['stage']) => 
                            handleUpdateCandidate({ ...selectedCandidate, stage: value })
                          }
                        >
                          <SelectTrigger>
                            <SelectValue />
